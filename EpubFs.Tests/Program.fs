...
let writeTests = testList "WriteTests" [
    testTask "No cover, auto nav, no css" {
        ...
        do! write generated metadata { CoverImage = None; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = []; OtherFiles = [] }
    ...
    testTask "Cover, auto nav, css" {
        ...
        do! write generated metadata { CoverImage = Some { Input = cover; MediaType = "image/jpeg"; Extension = ".jpg" }; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = [ { FileName = "main.css"; Input = new MemoryStream (css) } ]; OtherFiles = [] }
    ...
    testTask "Media overlay with SMIL" {
        use generated = new MemoryStream ()
        ...
        do! write generated metadata { CoverImage = None; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = [ cssFile ]; OtherFiles = [ audio ] }
