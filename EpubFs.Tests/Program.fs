...
let writeTests = testList "WriteTests" [
    test "No cover, auto nav, no css" {
        ...
        write generated metadata { CoverImage = None; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = []; AudioFiles = [] }
        
        // generated.Position <- 0L
        // File.WriteAllBytes ("samples/No cover, auto nav, no css.epub", generated.ToArray ())
    ...
    test "Cover, auto nav, css" {
        ...
        write generated metadata { CoverImage = Some { Input = cover; MediaType = "image/jpeg"; Extension = ".jpg" }; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = [ { FileName = "main.css"; Input = new MemoryStream (css) } ]; AudioFiles = [] }
        
        // generated.Position <- 0L
        // File.WriteAllBytes ("samples/Cover, auto nav, css.epub", generated.ToArray ())
    ...
    test "Media overlay with SMIL" {
        ...
        use audioData = File.OpenRead "samples/hello.mp3"
        let audio = { FileName = "audio.mp3"; MediaType = "audio/mpeg"; Input = audioData }
        ...
        write generated metadata { CoverImage = None; TitlePage = title; NavigationFile = Autogenerated; ContentFiles = [ p1; p2 ]; CssFiles = [ cssFile ]; AudioFiles = [ audio ] }

        // generated.Position <- 0L
        // File.WriteAllBytes ("samples/Media overlay with SMIL.epub", generated.ToArray ())
        compareEpubs generated "samples/Media overlay with SMIL.epub"
    }
